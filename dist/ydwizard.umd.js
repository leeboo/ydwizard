(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.ydwizard = factory());
  ...
  */
  ...
  var LangEn = {
      ...
      Preview: 'Preview',
      quit: 'Quit',
      settingDesc: 'mouse hovers element and then click "add wizard"',
      stopPreview: 'Stop preview',
      wizardText: 'Wizard Text'
  };
  ...
  var LangZhCn = {
      ...
      import: '导入',
      importSuccess: '导入成功',
      invalidJsonData: '无需的JSON数据',
      next: '上一个',
      pleaseInputText: '请输入提示文案',
      prev: '上一个',
      preview: '预览',
      quit: '退出',
      settingDesc: '鼠标悬浮于元素上点击"添加向导"进行设置',
      stopPreview: '停止预览',
      wizardText: '提示内容'
  };
  ...
  function getTranslate(target) {
      ...
      var translate = transform.replace(/translate|\(|\)|px/gi, '').split(',');
      if (translate.length !== 2)
          return { translateX: 0, translateY: 0 };
      return {
          translateX: parseInt(translate === null || translate === void 0 ? void 0 : translate[0].trim(), 10),
          translateY: parseInt(translate === null || translate === void 0 ? void 0 : translate[1].trim(), 10)
      };
  }
  ...
  function initSetting() {
      ...
      wizardPopper.innerHTML = "<div data-popper-arrow></div>\n<div style=\"\" class=\"ydw-ignore\">\n  <div style=\"".concat(wizardDialogStyle, "\" class=\"ydw-ignore\">\n    <div class=\"ydw-ignore\">").concat(translate('wizardText'), "\uFF1A</div>\n    <div class=\"ydw-ignore\">\n        <textarea style=\"resize: none\" class=\"ydw-ignore\" cols=\"60\" rows=\"3\" placeholder=\"").concat(translate('pleaseInputText'), "\"></textarea>\n    </div>\n  </div>\n</div>");
...
//# sourceMappingURL=ydwizard.umd.js.map
